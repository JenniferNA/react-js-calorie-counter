          ...
          <div>
            <Stack direction="row" >
              <li key={meal.id}><strong>{meal.name}:</strong> <em>{meal.calories} calories</em></li>
                <IconButton id="edit-icon" disabled={editMode} onClick={() => editMeal(meal.id)}>
                  <EditIcon/>
                </IconButton>
            </Stack>
            <Divider light />
      ...
      <Paper className='item-form' elevation={2}>
        <Stack spacing={2}>
            <Stack direction="row" justifyContent="space-between">
                ...
                <Button id="clr-btn" variant="contained" color="primary" component="div" display="flex" onClick={handleSubmit}>Clear All</Button>
            </Stack>
